...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::table('form_fields', function (Blueprint $table) {
            try {
                $table->dropUnique('form_fields_name_unique');
            } catch (Throwable $e) {
                //
            }

            try {
                $table->unique(['formulario_id', 'name'], 'form_fields_formulario_name_unique');
            } catch (Throwable $e) {
                //
            }
        });
    ...
    public function down(): void
    {
        Schema::table('form_fields', function (Blueprint $table) {
            try {
                $table->dropUnique('form_fields_formulario_name_unique');
            } catch (Throwable $e) {
                //
            }
